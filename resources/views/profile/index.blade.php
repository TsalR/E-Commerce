        ...
        <div class="col-md-12 mt-2">
            <div class="card">
                ...
                <form method="POST" action="{{ url('profile') }}">
                    ...
                    <div class="form-group row mt-2">
                        <label for="notelepon" class="col-md-2 col-form-label text-md-end">No. HP</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-md-6">
                        <textarea name="alamat" cols="10" rows="5" class="form-control @error('alamat') is-invalid @enderror" required="">{{$user->alamat}}</textarea>
                            @error('alamat')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
